          ...
          <div className="max-w-7xl mx-auto space-y-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              {statsData.map((stat, index) => (
                <div key={index} className="bg-[#050505] border border-[#232323] rounded-[20px] p-6">
                  <div className="space-y-3">
                    <div className="flex items-center gap-3">
                      <h3 className="text-base font-semibold text-[#F5F5F5]">{stat.title}</h3>
                    </div>
                    ...
                    <div className="space-y-5">
                      {stat.details.map((detail, detailIndex) => (
                        <div key={detailIndex} className="flex justify-between items-center">
                          <span className="text-sm text-[#C1C1C1]">{detail.label}</span>
                          <span className="text-sm text-[#C1C1C1]">{detail.value}</span>
                        </div>
                      ))}
                    </div>
                  </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              ...
              <div className="lg:col-span-2 bg-[#050505] border border-[#232323] rounded-[20px] p-6">
                <div className="flex items-center justify-between mb-6">
                  <h3 className="text-base font-semibold text-[#F5F5F5]">Inference history</h3>
                ...
                <div className="h-80 relative">
                  ...
                  <div className="ml-8 h-full border-l border-b border-[#232323] relative">
                    ...
                    <div className="absolute top-8 left-1/2 transform -translate-x-1/2 bg-[#050505] border border-[#8F8F8F] rounded-lg p-3">
                      <div className="text-base font-semibold text-[#F5F5F5]">27632</div>
              ...
              <div className="bg-[#191919] rounded-[20px] py-6">
                <div className="px-6 mb-4">
                  <h3 className="text-base font-semibold text-[#F5F5F5]">Recent activities</h3>
                </div>
                      ...
                      <div className="flex items-start gap-3 py-1">
                        ...
                        <div className="flex-1 space-y-2">
                          <div className="inline-block px-2 py-0.5 bg-[#2B2B2B] rounded-[20px]">
                            <span className="text-xs text-[#8F8F8F]">{activity.type}</span>
                          </div>
                          <div className="text-sm text-[#F0F0F0]">{activity.user}</div>
