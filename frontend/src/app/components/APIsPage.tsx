        ...
        <div className="flex-1 p-8 bg-[#191919]/15">
          <div className="max-w-7xl mx-auto space-y-0">
            ...
            <div className="bg-[#050505] border border-[#232323] rounded-t-[20px] border-b-0 p-6">
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center gap-4">
                  ...
                  {/* Generate API Button */}
                  <button className="bg-[#232323] text-[#F5F5F5] px-6 py-3 rounded-[20px] font-semibold text-base hover:bg-[#2B2B2B] transition-colors">
                    Generate API
                  </button>
            ...
            <div className="bg-[#050505] border border-[#232323] border-t-0 border-b-0 px-6 py-2">
              <span className="text-[#C1C1C1] text-base font-medium">Total APIs 2</span>
            </div>
            ...
            <div className="bg-[#080808] border border-[#191919] rounded-b-[20px] p-6">
              <div className="space-y-4">
                {apisData.map((api, index) => (
                  <div key={index} className="bg-transparent border border-[#232323] rounded-[20px] p-4">
                    <div className="flex items-center justify-between">
                      {/* API Info */}
