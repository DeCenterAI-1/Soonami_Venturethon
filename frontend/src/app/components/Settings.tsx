        ...
        <div className="fixed inset-0 bg-[rgba(5,5,5,0.5)] backdrop-blur-[3px] flex items-center justify-center z-50">
          <div className="w-[520px] bg-[#191919] border border-[#232323] rounded-[20px] p-6 backdrop-blur-[7.5px]">
            ...
            <div className="flex items-center justify-between mb-9">
              <h2 className="text-[#F5F5F5] text-2xl font-bold leading-8">Edit Profile</h2>
              <button
                onClick={() => setShowEditProfile(false)}
                className="p-2.5 hover:bg-[#2B2B2B] rounded-lg transition-colors"
              >
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M18.75 5.25L5.25 18.75M5.25 5.25L18.75 18.75" stroke="#8F8F8F" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                </svg>
              </button>
            </div>
            ...
            <div className="flex flex-col gap-9">
              ...
              <div className="flex justify-center">
                <div className="relative">
                  ...
                  <button className="absolute bottom-1 right-1 w-8 h-8 bg-[#2B2B2B] border border-[#191919] rounded-full flex items-center justify-center hover:bg-[#494949] transition-colors">
                    <svg width="16" height="17" viewBox="0 0 16 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path d="M13 4H11.2675L10.4156 2.7225C10.37 2.65409 10.3082 2.598 10.2357 2.55919C10.1632 2.52038 10.0822 2.50005 10 2.5H6C5.91777 2.50005 5.83682 2.52038 5.76432 2.55919C5.69182 2.598 5.63001 2.65409 5.58437 2.7225L4.73187 4H3C2.60218 4 2.22064 4.15804 1.93934 4.43934C1.65804 4.72064 1.5 5.10218 1.5 5.5V12.5C1.5 12.8978 1.65804 13.2794 1.93934 13.5607C2.22064 13.842 2.60218 14 3 14H13C13.3978 14 13.7794 13.842 14.0607 13.5607C14.342 13.2794 14.5 12.8978 14.5 12.5V5.5C14.5 5.10218 14.342 4.72064 14.0607 4.43934C13.7794 4.15804 13.3978 4 13 4Z" fill="#8F8F8F"/>
                    </svg>
                  </button>
                </div>
              </div>
              ...
              <div className="flex justify-end gap-6">
                ...
                <button className="w-[170px] px-6 py-3 bg-[#232323] rounded-[20px] text-[#F5F5F5] text-base font-semibold leading-6 opacity-40 cursor-not-allowed">
                  Save changes
                </button>
              </div>
            </div>
